            ...
            <div class="card-body p-0">
                ...
                <div class="border-bottom">
                    <nav class="nav nav-tabs px-4" id="pagesTab" role="tablist">
                        <button class="nav-link active fw-semibold" id="cookie-policy-tab" data-bs-toggle="tab"
                            data-bs-target="#cookie-policy" type="button" role="tab" aria-controls="cookie-policy"
                            aria-selected="true">
                            <i class="fas fa-cookie-bite me-2"></i>
                            Cookie Policy
                        </button>
                        <button class="nav-link fw-semibold" id="privacy-policy-tab" data-bs-toggle="tab"
                            data-bs-target="#privacy-policy" type="button" role="tab" aria-controls="privacy-policy"
                            aria-selected="false">
                            <i class="fas fa-shield-alt me-2"></i>
                            Privacy Policy
                        </button>
                        <button class="nav-link fw-semibold" id="terms-conditions-tab" data-bs-toggle="tab"
                            data-bs-target="#terms-conditions" type="button" role="tab"
                            aria-controls="terms-conditions" aria-selected="false">
                ...
                <div class="tab-content p-4" id="pagesTabContent">
                    <!-- Cookie Policy Tab -->
                    <div class="tab-pane fade show active" id="cookie-policy" role="tabpanel"
                        ...
                        <div class="mb-4">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted small mb-0">Define how your website uses cookies and tracking
                                        technologies</p>
                                </div>
                            </div>
                            ...
                            <form action="{{ route('handle.saveCookiePolicy') }}" method="POST" class="cookie-policy-form">
                                ...
                                <div class="editor-container mb-3">
                                    <textarea id="cookie_policy" name="cookie_policy" class="form-control" novalidate>{{ $pages->cookie_policy ?? '' }}</textarea>
                                </div>
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <button type="button" class="btn btn-outline-secondary btn-lg"
                                        onclick="resetEditor('cookie_policy')">
                    ...
                    <div class="tab-pane fade" id="privacy-policy" role="tabpanel" aria-labelledby="privacy-policy-tab">
                        <div class="mb-4">
                            ...
                            <form action="{{ route('handle.savePrivacyPolicy') }}" method="POST"
                                class="privacy-policy-form">
                                @csrf
                                <div class="editor-container mb-3">
                                    <textarea id="privacy_policy" name="privacy_policy" class="form-control" novalidate>{{ $pages->privacy_policy ?? '' }}</textarea>
                                </div>
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <button type="button" class="btn btn-outline-secondary btn-lg"
                                        onclick="resetEditor('privacy_policy')">
                                        <i class="fas fa-undo me-1"></i>Reset
                                    </button>
                                </div>
                            </form>
                        ...
                        <div class="mb-4">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted small mb-0">Set the rules and guidelines for using your website
                                    </p>
                                </div>
                            </div>

                            <form action="{{ route('handle.saveTermsConditions') }}" method="POST"
                                class="terms-conditions-form">
                                @csrf
                                <div class="editor-container mb-3">
                                    <textarea id="terms_and_conditions" name="terms_and_conditions" class="form-control" novalidate>{{ $pages->terms_and_conditions ?? '' }}</textarea>
                                </div>
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <button type="button" class="btn btn-outline-secondary btn-lg"
                                        onclick="resetEditor('terms_and_conditions')">
                                        <i class="fas fa-undo me-1"></i>Reset
                                    </button>
                                </div>
                            </form>
