...
<div class="container-fluid px-4 py-3">
    <!-- Back Button -->
    <div class="mb-3">
        <a href="/eventgallery" class="btn btn-outline-secondary">
            <i class="fas fa-arrow-left me-1"></i>Back to Event Gallery
        </a>
    </div>

    <!-- Edit Sub Event Gallery Form -->
    <div class="card shadow-sm border-0">
        <div class="card-header bg-white py-3 border-bottom">
            <h5 class="mb-0 fw-bold text-dark">
                <i class="fas fa-edit text-primary me-2"></i>
                Edit Sub Event Gallery Image - {{ $subEventImage->description }}
            </h5>
        </div>
        <div class="card-body">
            <form method="POST" enctype="multipart/form-data" action="{{ route('handle.updateEventSubPhoto', $subEventImage->id) }}">
                @method('PUT')
                @csrf
                ...
                <div class="row">
                    <div class="mb-4 col-md-6">
                        ...
                        <input type="text" 
                               ...
                               value="{{ $subEventImage->description }}"
                               required>
                    </div>
                    ...
                    <div class="mb-4 col-md-6">
                        ...
                        @if (!empty($subEventImage->image_path))
                            <div class="mt-3">
                                <label class="form-label fw-semibold text-muted">Current Image:</label>
                                <div class="current-image-container">
                                    <img src="{{ config('app.url').'/'.$subEventImage->image_path }}" 
                                         alt="Current Sub Event Image" 
                                         ...
                                         onclick="showImageModal('{{ config('app.url').'/'.$subEventImage->image_path }}', '{{ $subEventImage->description }}')">
                                </div>
                            ...
                            <div class="card-body py-3">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-3 text-center">
                                        @php
                                            // You might need to pass parent image data from controller
                                            // For now, using a basic display
                                        @endphp
                                        <div class="parent-badge">
                                            <span class="badge bg-info text-white fs-6 px-3 py-2">
                                                <i class="fas fa-images me-1"></i>
                                                Parent ID: {{ $subEventImage->image_id }}
                                            </span>
                                        </div>
                                    </div>
                                    <div class="col-md-9">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <div class="fw-semibold text-dark mb-1">Sub Image belongs to Main Gallery</div>
                                                <small class="text-muted">This sub image is linked to main event gallery image with ID {{ $subEventImage->image_id }}</small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row text-center">
                                    <div class="col-md-4">
                                        <div class="stat-item">
                                            ...
                                            <small class="text-muted">Sub Image ID</small>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="stat-item">
                                            <h4 class="fw-bold text-success mb-1">
                                                ...
                                                {{ $subEventImage->created_at->format('M d, Y') }}
                                            </h4>
                                    ...
                                    <div class="col-md-4">
                                        <div class="stat-item">
                                            <h4 class="fw-bold text-info mb-1">
                                                ...
                                                {{ $subEventImage->updated_at->format('M d, Y') }}
                                            </h4>
                ...
                <div class="d-flex gap-2 pt-3 border-top">
                    <button type="submit" class="btn btn-primary btn-lg">
                        <i class="fas fa-save me-1"></i>Update Sub Image
                    </button>
                    <a href="/eventgallery" class="btn btn-outline-secondary btn-lg">
...
.parent-badge .badge {
    box-shadow: 0 2px 8px rgba(93, 26, 30, 0.15);
    border-radius: 0.5rem;
}
...
<script>
    ...
    document.querySelector('form').addEventListener('submit', function(e) {
        ...
        setTimeout(() => {
            ...
            submitBtn.innerHTML = '<i class="fas fa-save me-1"></i>Update Sub Image';
        }, 3000);
    });
