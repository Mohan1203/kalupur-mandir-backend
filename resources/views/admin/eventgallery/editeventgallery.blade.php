...
<div class="container-fluid px-4 py-3">
    ...
    <!-- Edit Main Event Gallery Form -->
    <div class="card shadow-sm border-0">
        <div class="card-header bg-white py-3 border-bottom">
            <h5 class="mb-0 fw-bold text-dark">
                <i class="fas fa-edit text-primary me-2"></i>
                Edit Main Event Gallery Image - {{ $eventImage->description }}
            </h5>
        </div>
        <div class="card-body">
            <form method="POST" enctype="multipart/form-data" action="{{ route('handle.updateEventGallery', $eventImage->id) }}">
                @method('PUT')
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="mb-4 col-md-6">
                        ...
                        @if (!empty($eventImage->image_path))
                            <div class="mt-3">
                                <label class="form-label fw-semibold text-muted">Current Image:</label>
                                <div class="current-image-container">
                                    <img src="{{ config('app.url').'/'.$eventImage->image_path }}" 
                                         ...
                                         onclick="showImageModal('{{ config('app.url').'/'.$eventImage->image_path }}', '{{ $eventImage->description }}')">
                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="stat-item">
                                            <h4 class="fw-bold text-success mb-1">
                                                ...
                                                {{ $eventImage->created_at->format('M d, Y') }}
                                            </h4>
                                    ...
                                    <div class="col-md-4">
                                        <div class="stat-item">
                                            <h4 class="fw-bold text-info mb-1">
                                                ...
                                                {{ $eventImage->updated_at->format('M d, Y') }}
                                            </h4>
