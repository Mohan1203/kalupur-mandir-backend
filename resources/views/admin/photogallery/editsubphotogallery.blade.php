...
<div class="container-fluid px-4 py-3">
    ...
    <!-- Edit Sub Photo Gallery Form -->
    <div class="card shadow-sm border-0">
        <div class="card-header bg-white py-3 border-bottom">
            <h5 class="mb-0 fw-bold text-dark">
                <i class="fas fa-edit text-primary me-2"></i>
                Edit Sub Photo Gallery Image - {{ $image->title }}
            </h5>
        </div>
        <div class="card-body">
                                    ...
                                    <div class="col-md-3">
                                        <div class="stat-item">
                                            <h4 class="fw-bold text-info mb-1">
                                                ...
                                                Parent: {{ $image->photo_id ?? 'N/A' }}
                                            </h4>
                                            <small class="text-muted">Parent Image ID</small>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="stat-item">
